...
/**
 * QuantizationTable class for managing JPEG quantization tables
 */
export class QuantizationTable {
  ...
  /** Quantization tables [4][64] */
  quantTables: number[][] = createArray<number[]>(4, 64);

  /**
   * Apply DCT enhancement to quantization table
   * @param qtab - Quantization table to enhance
   * @param table - Zigzag table for reordering
   */
  ...
  /**
   * Parse quantization table from DataStream
